...
setTimeout(function () {
    ...
    var globalAmbient = 0.3;

    var startTick = new Date().getTime();

    rayTracer.render(
        new Viewport(
            new Vector3(0.0, 3.0, 10.0),
        ...
        {
            objects: [
                new SceneObjects.Plane(Vector3.BACKWARD, -10.0, Color.GREEN, 0.7, globalAmbient, 0, null), // back wall
                new SceneObjects.Plane(Vector3.UP, -10.0, Color.PURPLE, 0.7, globalAmbient, 0, null), // floor
                new SceneObjects.Plane(Vector3.DOWN, -10.0, Color.CYAN, 0.7, globalAmbient, 0, null),   // ceiling
                new SceneObjects.Plane(Vector3.RIGHT, -10.0, Color.YELLOW, 0.7, globalAmbient, 0, null), // left wall
                new SceneObjects.Plane(Vector3.LEFT, -10.0, Color.BLUE, 0.7, globalAmbient, 0, null),  // right wall
